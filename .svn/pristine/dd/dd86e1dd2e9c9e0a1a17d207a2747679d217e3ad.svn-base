											...
											<form role="form">
												<div class="form-group">
													<label>用户名</label> <input class="form-control"
														disabled="disabled" value="${loginUser.username }">
												</div>
												<div class="form-group">
													<label>昵称</label> <input class="form-control"
														value="${loginUser.nickname }" placeholder="请输入昵称">
												</div>
												<div class="form-group">
													<label>电话号码</label> <input class="form-control"
														value="${loginUser.telephone }" placeholder="请输入昵称">
												</div>
												<div class="form-group">
													<label>电子邮箱</label> <input class="form-control"
														value="${loginUser.email }" placeholder="请输入昵称">
												</div>
								...
								<div class="tab-pane fade" id="profile">
									...
									<div class="row">
										<div class="col-lg-6">
											<form role="form">
												<div class="form-group">
													<label>当前密码</label> <input class="form-control"
														placeholder="请输入当前密码">
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													<label>确认新密码</label> <input class="form-control"
