				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<button id="btnResetPassword" type="button"
								class="btn btn-primary">确定重置</button>
						</div>
					</div>
					<!-- /.modal-content -->
				</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input id="username" type="text" class="form-control"
											placeholder="请输入用户名  *可以是字母，数字，下画线_或其组合)"
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<button id="setDefaultPwd" class="btn btn-success"
											onclick="document.getElementById('password').value=12345678">初始密码为12345678</button>
									</div>
								</div>
								<div class="form-group">
										...
										<c:forEach items="${userList }" var="user" varStatus="status">
											<tr>
												...
												<td><button type="button"
														...
														accesskey="${user.id }">重置密码</button></td>
												<td>
