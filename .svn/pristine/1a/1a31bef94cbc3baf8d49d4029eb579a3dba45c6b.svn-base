...
<!-- Font Awesome -->
<link rel="stylesheet"
	href="${ctx}/assets/plugins/bootstrap-plugin/bootstrap-iconpicker/icon-fonts/font-awesome-4.2.0/css/font-awesome.min.css" />
<!-- Bootstrap-Iconpicker -->
<link rel="stylesheet"
	href="${ctx}/assets/plugins/bootstrap-plugin/bootstrap-iconpicker/css/bootstrap-iconpicker.min.css" />
<!-- easyform -->
<link href="${ctx }/assets/plugins/easyform/easyform.css"
	rel="stylesheet" type="text/css">
<link href="${ctx }/assets/plugins/ztree/css/zTreeStyle/zTreeStyle.css"
	rel="stylesheet" type="text/css">
<link href="${ctx }/assets/mobile/weui/css/weui.css" rel="stylesheet"
	type="text/css">
<title>${title }</title>
</head>
<body>
...
<script type="text/javascript"
	src="${ctx }/assets/plugins/bootstrap-plugin/bootstrap-iconpicker/js/iconset/iconset-fontawesome-4.2.0.min.js"></script>
<!-- Bootstrap-Iconpicker -->
<script type="text/javascript"
	src="${ctx }/assets/plugins/bootstrap-plugin/bootstrap-iconpicker/js/bootstrap-iconpicker.min.js"></script>
<!-- easyform -->
...
<script type="text/javascript"
	src="${ctx }/assets/plugins/ztree/js/jquery.ztree.exedit.js"></script>
<script>
