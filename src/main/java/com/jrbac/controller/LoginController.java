...
public class LoginController {
    ...
    public String doLogin(Model model, HttpSession session, HttpServletRequest request, RedirectAttributes redirectAttributes, @RequestParam("usernamePost") String username, @RequestParam("passwordPost") String password) {
        // 得到加密密钥
        ...
        try {
            ...
            if (subject.isAuthenticated()) {
                ...
                if (null != loginUser) {
                    ...
                    // 将登录用户信息保存到session中
                    /*
                     * LoginUserVO loginUserVo = new LoginUserVO(); BeanUtils.copyProperties(loginUser, loginUserVo);
                     */
