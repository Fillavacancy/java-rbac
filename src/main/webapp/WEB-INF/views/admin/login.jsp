...
<body class="templatemo-bg-image">
				...
				<div class="row">
					<div class="templatemo-one-signin">
						...
						<div class="form-group">
							<div class="col-md-12">
								<div class="checkbox">
									<label> <input id="rememberMe" type="checkbox">记住我
									</label> <label>
									...
									</label> <img id="validateCode" class="authCodeImg"
										src="${ctx }/gesture/validateCode?time=<%=new Date().getTime() %>"
										title="看不清可单击图片刷新"
										onclick='this.src="${ctx }/gesture/validateCode?time="+new Date().getTime();'>
								</div>
	...
	<div style="display: none">
		<form id="postForm" action="<c:url value='/doLogin.html'/>"
			method="post">
			<input id="postUsername" name="usernamePost"> <input
				id="postPassword" name="passwordPost">
		</form>
		<input type="hidden" id="ctx" value='${ctx }'> <input
			type="hidden" id="msg" value='${msg }'> <input type="hidden"
			id="key" value='${loginDesKey }'>
	</div>
</body>
